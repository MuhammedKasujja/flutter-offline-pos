...
import 'package:offline_kalteck_pos/constants/asset_paths.dart';
import 'package:offline_kalteck_pos/core/mobile/create_order_new/ui/cart_screen.dart';
import 'package:offline_kalteck_pos/core/mobile/finance/ui/finance.dart';
import 'package:offline_kalteck_pos/core/mobile/my_account/ui/my_account.dart';
import 'package:offline_kalteck_pos/widgets/search_widget.dart';
                    ...
                    SearchWidget(
                      ...
                      submit: () {
                        if (_searchTxtController.text.length >= 3) {
                          _filterProductsCategories(_searchTxtController.text);
                        } else {
                          getProducts();
                        }
                      },
